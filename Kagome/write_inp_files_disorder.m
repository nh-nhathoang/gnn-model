...
% Geomtery which can be 'Demi-A','Demi-B','Demi-C','Kag'
lattice = 'Kag';
...
[left,right,bottom,top] = find_edges(Pvert,L);
...
%%
function [left,right,bot,top] = find_edges(Vert,L)

% Find indices of vertices on the bottom (y<L/2)
bot = find(Vert(:,2) < .52*L);
